...
export declare const debounce: <T extends unknown[], U>(
...
export declare const activeCellClass: ({
  cells,
  activeName,
  color,
...
export declare const hasStickyColumnStyle: ({
  colIndex,
  stickyLeftColumn,
  stickyRightColumn,
  tableHeadersLength,
...
export declare const standardSortParams: (
  sortBy: SortByProps,
