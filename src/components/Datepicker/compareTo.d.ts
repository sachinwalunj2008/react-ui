 ...
 **/
export declare const customTimeSelection: ({
 ...
 **/
export declare const previousPeriod: ({
 ...
 **/
export declare const previousPeriodMatchDays: ({
  firstRange_startDate,
  firstRange_endDate,
  secondRange_startDate,
  secondRange_endDate,
 ...
 **/
export declare const previousMonth: ({
  firstRange_startDate,
  firstRange_endDate,
  secondRange_startDate,
  secondRange_endDate,
 ...
 *    - It can only be used on any selection less than 30 days.
 **/
export declare const previousMonthMatchDays: ({
  firstRange_startDate,
  firstRange_endDate,
  secondRange_startDate,
  secondRange_endDate,
 ...
 **/
export declare const previousYear: ({
  firstRange_startDate,
  firstRange_endDate,
  secondRange_startDate,
  secondRange_endDate,
 ...
 **/
export declare const previousYearMatchDays: ({
  firstRange_startDate,
  firstRange_endDate,
  secondRange_startDate,
  secondRange_endDate,
