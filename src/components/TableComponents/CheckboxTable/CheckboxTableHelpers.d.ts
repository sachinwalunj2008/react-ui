...
export declare const headerStyle: (
  isStickyLeftColumn: boolean,
  isMobileView: boolean,
  heightOfHeaderRow?: number
) => React.CSSProperties
export declare const stickyTableHeaderCount: (
  stickyTableConfig?: StickyTableConfigType
) => number
export declare const getStickyRightCount: (
  stickyTableConfig?: StickyTableConfigType,
  customColumnProps?: boolean
) => number
export declare const customColumnStickyStyles: string
export declare const getStickyLeftCount: (
  stickyTableConfig?: StickyTableConfigType
) => number
export declare function useMobileCheckboxes(
