...
import { addNewBreadcrumb } from './BreadcrumbsService'
...
const Template: ComponentStory<typeof Breadcrumbs> = (args) => {
  ...
  const navigateFromBreadcrumbs = (index, link) => {
    if (!index) {
      index = breadcrumbs.findIndex((crumb) => crumb.link === link)
    }
...
characterLimit.storyName = 'Character Limit (10)'

export const dynamicForMobile = Template.bind({})
dynamicForMobile.args = {
  breadcrumbs: [
    {
      name: 'Level 1',
      link: '/level-1',
...
dynamicForMobile.storyName = 'Dynamic Names for Mobile'
